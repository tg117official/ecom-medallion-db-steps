...
child_table = "bronze_inventory_level"
parent_table = "bronze_product_variant"
child_column = "product_variant_id"
parent_column = "product_variant_id"
...
# valid_df.write.format("delta").mode("append").saveAsTable("ecomsphere.silver.silver_inventory_snapshot")
# invalid_df.write.format("delta").mode("append").saveAsTable("ecomsphere.silver_quarantine.silver_quarantine.inventory_product_variant_reference_rejections")