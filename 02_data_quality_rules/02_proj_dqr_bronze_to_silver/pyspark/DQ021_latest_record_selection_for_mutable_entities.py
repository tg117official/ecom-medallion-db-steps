...
# dedup_df.write.format("delta").mode("append").saveAsTable("ecomsphere.silver.multiple")
# duplicate_df.write.format("delta").mode("append").saveAsTable("ecomsphere.silver_quarantine.quarantine_table_name")

print("=" * 80)
print("PROCESSING bronze_product")
print("=" * 80)

sample_data = [("K1","2026-03-10 09:00:00"), ("K1","2026-03-10 09:10:00"), ("K2","2026-03-10 09:20:00")]
schema = "id string, updated_at string"
df = spark.createDataFrame(sample_data, schema=schema).withColumn("updated_at", to_timestamp("updated_at"))
...
partition_cols = ['product_variant_id']
