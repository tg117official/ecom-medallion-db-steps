# ============================================================
# DQ002 - Valid JSON structure for file-based records
...
dq_run_id = "DQ002_RUN_001"
rule_name = "Valid JSON structure for file-based records"
...
# invalid_df.write.format("delta").mode("append").saveAsTable("ecomsphere.silver_quarantine.silver_quarantine.json_structure_rejections")
