...
child_table = "bronze_product_catalog_feed"
...
print("SECONDARY REFERENCE EXISTS IN CATALOG BUT TEMPLATE CURRENTLY DEMO-ONLY")

# valid_df.write.format("delta").mode("append").saveAsTable("ecomsphere.silver.silver_dim_product_master")
# invalid_df.write.format("delta").mode("append").saveAsTable("ecomsphere.silver_quarantine.silver_quarantine.catalog_product_reference_rejections")